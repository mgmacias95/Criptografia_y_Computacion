...
Todos estos pasos están reflejados en la función \texttt{baby_s_giant_s} que he desarrollado:

\begin{minted}[linenos, frame=lines, label={baby_s_giant_s}]{haskell}
